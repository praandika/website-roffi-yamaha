...
<head>
    ...
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/525e15fb5e.js" crossorigin="anonymous"></script>
    <!-- Material Icons -->
    <link rel="stylesheet"
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                    ...
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group input-group-outline">
                            ...
                            <a href="https://wa.me/6281246571421" target="_blank">
                                <input type="text" class="form-control" style="cursor: pointer;" readonly>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container-fluid py-2">
            <div class="row">
                <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">@yield('page-title')</h3>
                </div>
            </div>
            @yield('content')
